          ...
          <div class="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
            <div class="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2">
              <div class="flex flex-shrink-0 items-center">
                <a href="">
                  <img class="block h-8 w-auto" src="/images/—Pngtree—taxi vector icon_3722634.png" alt="Your Company" width="80"
                  height="80">
                </a>
              </div>
            </div>
                ...
                <table class="w-full table-fixed">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Traject</th>
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Paiment-Type</th>
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Jour</th>
